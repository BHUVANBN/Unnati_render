...
import { CreateTestimonial, createTestimonialSchema, Placement, Testimonial } from "@/schemas";
                  ...
                  <FormControl>
                    <div className="flex items-center gap-1">
                      {[1, 2, 3, 4, 5].map((starIndex) => {
                        const isFilled = field.value >= starIndex;
                        return (
                          <Star
                            key={starIndex}
                            className={`h-6 w-6 cursor-pointer transition-colors ${isFilled ? "text-yellow-400" : "text-gray-300"}`}
                ...
                <FormItem className="space-y-2">
                  ...
                  <FormControl>
                    ...
                    >
                      ...
                      <SelectContent>
                        {Array.isArray(placements) && placements.map((placement: Placement) => (
