                            ...
                            {isLoading ? (
                                ...
                                filtered.map((b) => (
                                    <TableRow key={b.id}>
                                        ...
                                        <TableCell className="w-40"><div className="truncate" title={b.name}>{b.name}</div></TableCell>
                                        <TableCell className="w-40">
                                            <div className="truncate" title={b.designation}>{b.designation}</div>
                                        </TableCell>
                                        <TableCell className="w-60">
                                            <div className="truncate" title={b.expertise}>{b.expertise}</div>
                                        </TableCell>
                                        <TableCell className="w-40">
                                            <div className="truncate" title={b.experience}>{b.experience}</div>
                                        </TableCell>
