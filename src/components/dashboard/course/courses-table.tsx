          ...
          <Table>
            ...
            <TableBody>
              {isLoading ? (
                <TableLoadingRows
                  rows={6}
                  columns={["h-4 w-44", "h-4 w-44", "h-4 w-20", "h-4 w-36", "h-4 w-36", "h-8 w-16 rounded"]}
                />
                ...
                <>
                  {filteredCourses.map((course: Course) => (
                    <TableRow key={course.id}>
                      ...
                      <TableCell className="max-w-44">
                        <div className="truncate" title={course.syllabus.subtitle}>{course.syllabus.subtitle}</div>
                      </TableCell>
                      <TableCell className="max-w-20">
                        <div className="truncate" title={course.additionalInfo.duration}>{course.additionalInfo.duration}</div>
                      </TableCell>
                      <TableCell className="max-w-36">
                        <div className="truncate" title={course.additionalInfo.languages.join(", ")}>{course.additionalInfo.languages.join(", ")}</div>
                      </TableCell>
                      <TableCell className="max-w-36">
                        <div className="truncate" title={course.additionalInfo.mode.join(", ")}>{course.additionalInfo.mode.join(", ")}</div>
                      </TableCell>
                      <TableCell>
                        <DropdownMenu>
