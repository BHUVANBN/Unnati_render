          ...
          <Table>
            ...
            <TableBody>
              {isLoading ? (
                <TableLoadingRows
                  rows={6}
                  columns={["h-4 w-20", "h-4 w-40", "h-4 w-40", "h-4 w-40", "h-8 w-12 rounded"]}
                />
                ...
                <>
                  {filteredPlacements.map((placement: Placement) => (
                    <TableRow key={placement.id}>
                      <TableCell className="w-20">{placement.photo?.url ? <img src={placement.photo.url} alt="photo" className="h-8 w-8 rounded-full" /> : "-"}</TableCell>
                      <TableCell className="w-40">
                        <div className="truncate" title={placement.name}>{placement.name}</div>
                      </TableCell>
                      <TableCell className="w-40">
                        <div className="truncate" title={placement.role}>{placement.role}</div>
                      </TableCell>
                      <TableCell className="w-40">
                        <div className="truncate" title={placement.company?.name}>{placement.company?.name}</div>
                      </TableCell>
                      <TableCell>
                        <DropdownMenu>
